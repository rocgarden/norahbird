    ...
    <div className="container mx-auto my-5 transition ease-in-out delay-150 bg-gradient-to-r from-blue-800 to-blue-300">
      <div className="text-center pt-12">
        <p className="text-[40px] text-wrap">
          Get Expert Advice From Real People
        </p>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
        <div className="flex justify-center items-center">
          <p className="text-center max-w-xs">There's lots to do on a weekend trip. You can explore through the hills on a beautfiful hike.</p>
        </div>
        <div className="flex justify-center items-center">
