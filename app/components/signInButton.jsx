      ...
      <div>
        ...
        <Menu.Button>
         ...
         <Transition
          ...
          >  
         <Menu.Items className='bg-react dark:text-react absolute z-10 right-0 mt-1 flex w-96 origin-top-right flex-col rounded-xl py-6 text-white shadow-lg focus:outline-none dark:bg-white'>
